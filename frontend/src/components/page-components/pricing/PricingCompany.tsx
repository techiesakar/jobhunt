...
const PricingCompany = (props: PropsType) => {
    return (
        <section className="py-14 lg:py-20 gap-8 lg:gap-12 bg-gray-100">
            <div className="huntContainer  flex flex-col gap-14">
                <div className="flex flex-col gap-4 md:gap-6">
                    <h1 className="huntHead">
                        Plan options for companies
                        ...
                        return (
                            <div key={item.plan} className='card flex flex-col gap-8 bg-white rounded-md p-6 border-gray-200' >
                                <div className='border-b border-gray-300 pb-6  text-center '>
                                    <div className='text-blue-700 font-bold text-lg'>{item.plan}</div>
                                ...
                                <ul className='flex flex-col gap-4'>
                                    {item.features.map((feature: string) => {
                                        return (
                                            <li key={feature} className='text-para flex gap-3'><CheckCircleIcon sx={{ fontSize: 20 }} className='text-blue-700' />{feature}</li>
                                        )
                                    })}
                                </ul>
